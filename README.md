...
The schedule is defined in `.github/workflows/cleanup.yml` as a cron expression.

**Recommended workflow:**

1. Start with a manual dry run to review what would be deleted.
2. Run manually with `dry_run: false` once you're satisfied.
3. Enable the schedule for automated nightly cleanup.
...
Contributions, issues, and feature requests are highly encouraged! Fork the repo, make your changes, and open a Pull Request. For major changes, please open an issue first to discuss.

---

## ☕ Support & Donate

If this tool has saved you time, server costs, or GitHub Action minutes, consider supporting the project. It helps keep these tools free, maintained, and updated.
